...
coluna_analise = df['Atividade']

# Converter palavras para maiúsculas antes de contar
coluna_analise = coluna_analise.str.upper()

# Criar um conjunto para armazenar os nomes sem repetições
nomes_unicos = set(coluna_analise)

# Ordenar os nomes em ordem alfabética
nomes_unicos = sorted(nomes_unicos)

# Salvar os nomes em um arquivo TXT
with open('nomes_unicos_alfabeticos.txt', 'w') as arquivo:
